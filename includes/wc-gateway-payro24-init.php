...
function wc_gateway_payro24_init()
{
    ...
    if (class_exists('WC_Payment_Gateway')) {
        ...
        class WC_payro24 extends WC_Payment_Gateway
        {
            ...
            {
                $this->id = 'WC_payro24';
                $this->method_title = __('پیرو ۲۴', 'woo-payro24-gateway');
                $this->method_description = __('هدایت مشتری به پیرو ۲۴ برای پردازش پرداخت', 'woo-payro24-gateway');
            ...
            public function init_form_fields()
            {
                ...
                $this->form_fields = apply_filters('WC_payro24_Config', array(
                    'enabled' => array(
                        'title' => __('فعال/غیرفعال', 'woo-payro24-gateway'),
                        'type' => 'checkbox',
                        'label' => 'فعال سازی درگاه پرداخت پیرو',
                        'description' => 'جهت فعال سازی درگاه پرداخت پیرو ۲۴ برای کاربران خود این قسمت را فعال کنید',
                        'default' => 'yes',
                    ),
                    'title' => array(
                        'title' => __('عنوان', 'woo-payro24-gateway'),
                        'type' => 'text',
                        'description' => __('این عنوان درگاه پرداخت هنگام تسویه حساب به کاربرانتان نشان داده میشود', 'woo-payro24-gateway'),
                        'default' => __('درگاه پرداخت پیرو ۲۴', 'woo-payro24-gateway'),
                    ),
                    'description' => array(
                        'title' => __('توضیحات', 'woo-payro24-gateway'),
                        'type' => 'textarea',
                        'description' => __('این متن وقتی نشان داده میشود که کاربر درحال رفتن به تسویه حساب است', 'woo-payro24-gateway'),
                        'default' => __('هدایت مشتری به پیرو ۲۴ برای پردازش پرداخت', 'woo-payro24-gateway'),
                    ),
                    'webservice_config' => array(
                        'title' => __('تنظیمات وبسرویس', 'woo-payro24-gateway'),
                        'type' => 'title',
                        'description' => '',
                    ),
                    'api_key' => array(
                        'title' => __('کلید API', 'woo-payro24-gateway'),
                        'type' => 'text',
                        'description' => __('شما میتوانید با ساخت وبسرویس در پیرو به صورت کاملا رایگان به کلید وبسرویس خود دسترسی داشته باشید https://panel.payro24.ir/#/list/webservices', 'woo-payro24-gateway'),
                        'default' => '',
                    ),
                    'sandbox' => array(
                        'title' => __('سندباکس', 'woo-payro24-gateway'),
                        'label' => __('فعال سازی حالت سندباکس (تستی)', 'woo-payro24-gateway'),
                        'description' => __('درصورت فعال سازی این گزینه درگاه به صورت تست اجرا میشود.', 'woo-payro24-gateway'),
                        'type' => 'checkbox',
                        'default' => 'no',
                    ),
                    'message_confing' => array(
                        'title' => __('تنظیمات پیام های پرداخت', 'woo-payro24-gateway'),
                        'type' => 'title',
                        'description' => __('تنظیمات پیغام هایی که کاربر در صورت برگشت از پیرو باید مشاهده کند', 'woo-payro24-gateway'),
                    ),
                    'success_message' => array(
                        'title' => __('پیغام موفقیت', 'woo-payro24-gateway'),
                        'type' => 'textarea',
                        'description' => __('پیامی که در صورت عملیات موفق به کاربر نمایش داده میشود شما میتوناید از {order_id} برای نمایش شماره سفارش و {track_id} برای نمایش شماره پیگیری استفاده کنید', 'woo-payro24-gateway'),
                        'default' => __('پرداخت شما موفقیت آمیز بود شماره پیگیری : {track_id}', 'woo-payro24-gateway'),
                    ),
                    'failed_message' => array(
                        'title' => __('پیغام عملیات ناموفق', 'woo-payro24-gateway'),
                        'type' => 'textarea',
                        'description' => __('پیامی که در صورت عملیات نا موفق به کاربر نمایش داده میشود شما میتوناید از {order_id} برای نمایش شماره سفارش و {track_id} برای نمایش شماره پیگیری استفاده کنید', 'woo-payro24-gateway'),
                        'default' => __('عملیات پرداخت انجام نشد. درصورت کسر وجه مبلغ کسر شده تا ۷۲ ساعت آینده به حساب شما بازگشت داده میشود', 'woo-payro24-gateway'),
                    ),
                ));
            }
